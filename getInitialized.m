...
assigned2=regexp(str,'\[([a-zA-Z_$][a-zA-Z_$0-9,]*)\] *\=',"tokens"); %get variables assigned by a function with nargout>1
assigned2=cellfun(@(x) split(x(1),',')', assigned2,'UniformOutput',0);
